Lab 8 Configuring an Identity
Provider in VCF Automation
...
35
a. On the Chrome bookmarks bar, right-click VCF Automation and select Open in new
incognito window.
...
1. On the Provider Management page, ensure that Identity Providers is selected under
Administration.
2. Click TEST.
