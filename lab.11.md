...
i. Click + ADD to add the IP range.
b. Click NEXT.
...
a. Click NEXT.
6. Under Associated IP Spaces, select the region1_IP_Space checkbox.
a. Click NEXT.
7. Verify the settings in the Review and Complete pane and click CREATE.
