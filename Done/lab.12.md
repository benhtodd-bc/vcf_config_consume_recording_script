# Lab 12 Creating a Provider Content Library
...
7. Under ```Storage Class```, select s```upervisor-storage-policy```.
...
6. Verify that Provider_CL is selected in the Content Library 
